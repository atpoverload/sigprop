...
/** A {SubscribeableClockSignalClockSignal} that updates the downstream concurrently. */
public final class ConcurrentClockSignal extends SubscribeableClockSignal {
